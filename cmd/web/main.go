...
// configuration and logs a safe view of it; the HTTP server lands in a later
// phase.
package main
...
// run loads the web configuration, logs a secret-masked view of it, and
...
func run(ctx context.Context, logger *slog.Logger) error {
	_ = ctx // signal handling + server loop land in a later phase.
